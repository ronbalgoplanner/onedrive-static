  ...
  return (function o(a, s, u) {
  ...
  })(
    {
      ...
      3: [
        ...
        { "./controllers/Picker": 8, "./controllers/Saver": 10, "./models/ErrorType": 13, "./models/OneDriveSdkError": 16, "./utilities/ErrorHandler": 26, "./utilities/Logging": 27 },
      ],
      4: [
        function (e, t, r) {
          !(function (e, t, d, p, f, c, h, v, m, g, y) {
            ...
            function T(e, t, r) {
              ...
              var o = new g.default({ url: i, clientId: t.clientId, method: g.default.HTTP_GET, apiEndpoint: t.apiEndpoint, headers: { Authorization: "bearer " + t.accessToken } });
              ...
              return new y.Promise(function (i, n) {
                o.start(
                  ...
                  function (e, t, r) {
                    n({ errorCode: p.default[p.default.webRequestFailure], message: "HTTP error status: " + t });
                  }
                );
              });
            }
            ...
            function u(o, e, t) {
              var a = m.appendToPath(b(o, e.apiEndpointUrl), v.format("{0}.createLink", e.apiActionNamingSpace)),
                r = new g.default({ url: a, clientId: e.clientId, method: g.default.HTTP_POST, apiEndpoint: e.apiEndpoint, headers: { Authorization: "bearer " + e.accessToken }, json: JSON.stringify(t) });
              return new y.Promise(function (i, n) {
                r.start(
                  function (e, t, r) {
                  ...
                  function (e, t, r) {
                    ...
                    n({ errorCode: p.default[p.default.webRequestFailure], message: t });
                  }
                );
              });
            }
            ...
            t.saveItemByFormUpload = function (u, l, e, d, c) {
              ...
              return new y.Promise(function (a, s) {
                ...
                t.onload = function (e) {
                  ...
                  var n = new g.default({ url: m.appendQueryStrings(t, r), clientId: d.clientId, headers: i, apiEndpoint: d.apiEndpoint }),
                    o = e.target.result;
                  n.upload(
                    o,
                    function (e, t) {
            ...
            t.saveItemByUriUpload = function (e, t, r, i) {
              ...
              var s,
                u,
                l = new g.default({ url: o, clientId: i.clientId, method: g.default.HTTP_POST, headers: a, json: JSON.stringify(t), apiEndpoint: i.apiEndpoint });
                ...
                ? ((u = l),
                  new y.Promise(function (i, n) {
                    u.start(
                      function (e, t) {
                        if (200 === t || 201 === t) {
                          var r = { webUrl: null, value: [c.deserializeJSON(e.responseText)] };
                          i(r);
                  ...
                  new y.Promise(function (i, n) {
                    s.start(
                      function (e, t) {
                        if (202 === t) {
                          ...
                          r || n({ errorCode: p.default.badResponse, message: "missing 'Location' header on response" });
                          i(r);
                    ...
                    new y.Promise(function (n, a) {
                      !(function t(r, i) {
                        ...
                        ((e = s),
                        (o = new g.default({ url: e, method: g.default.HTTP_GET })),
                        new y.Promise(function (i, n) {
                          o.start(
                            function (e, t) {
                              switch (t) {
            ...
            t.getUserTenantUrl = function (e) {
              ...
              var o = new g.default({ url: t, clientId: e.clientId, method: g.default.HTTP_GET, headers: r, apiEndpoint: e.apiEndpoint });
              return new y.Promise(function (i, n) {
                o.start(
                  function (e, t) {
                    var r = c.deserializeJSON(e.responseText);
        ...
        { "../models/ApiEndpoint": 11, "../models/ErrorType": 13, "../models/OneDriveSdkError": 16, "../utilities/Logging": 27, "../utilities/ObjectUtilities": 28, "../utilities/StringUtilities": 30, "../utilities/UrlUtilities": 32, "../utilities/XHR": 33, "es6-promise": 34 },
      ],
      5: [
        function (e, t, r) {
            ...
            var g = (function () {
              ...
              e.prototype.buildPickerUI = function (e) {
                ...
                if (e) {
                  ...
                  r = { loginHint: null, timeStamp: null, apiEndpoint: t ? n.default.msa : n.default.filesV2, endpointHint: t ? c.default.msa : c.default.tenant, isConsumerAccount: t };
                }
              ...
              e.prototype.buildApiConfig = function () {
                ...
                return { accessToken: this.oauthResponse ? this.oauthResponse.accessToken : this.invokerOptions.accessToken, apiEndpoint: this.loginHint.apiEndpoint, apiEndpointUrl: e, apiActionNamingSpace: t, clientId: this.invokerOptions.clientId };
              };
        ...
        { "../Constants": 1, "../models/ApiEndpoint": 11, "../models/DomainHint": 12, "../models/ErrorType": 13, "../models/OneDriveSdkError": 16, "../utilities/ErrorHandler": 26, "../utilities/Logging": 27, "../utilities/Popup": 29, "../utilities/StringUtilities": 30, "../utilities/UrlUtilities": 32, "./ApiRequest": 4, "./LoginCache": 6, "./Oauth": 7, "./PickerUX": 9, "es6-promise": 34 },
      ],
      6: [
        function (e, t, r) {
          !(function (e, t, d, c, p, f, i, n, o, a) {
            ...
            t.updateLoginHint = function (e, t, r) {
              ...
              var u = { apiEndpoint: o, loginHint: i, endpointHint: n, timeStamp: new Date().getTime(), isConsumerAccount: a },
                l = c.getCacheItem(h) || {};
              l["od7-" + e] = u;
              c.setCacheItem(h, l);
              return u;
        ...
        { "../Constants": 1, "../models/ApiEndpoint": 11, "../models/DomainHint": 12, "../models/ErrorType": 13, "../models/OneDriveSdkError": 16, "../utilities/Cache": 22, "../utilities/ErrorHandler": 26, "../utilities/ObjectUtilities": 28 },
      ],
      7: [
        function (e, t, r) {
          !(function (e, t, r, a, u, s, l, d, c, p, i, f) {
            ...
            function T(e, t) {
              ...
              e[m]
                ? (function (e) {
                    ...
                    switch (e.endpoint) {
                      case c.default.AAD:
                        t = ((o = e), f.appendQueryStrings(y, { redirect_uri: o.redirectUri, client_id: o.clientId, response_type: "token", state: o.state, resource: o.resource || o.origin }));
                        break;
                        ...
                        t =
                          ((i =
                            ...
                            (r = e).scopes
                              ...
                              .join(" ")),
                          (n = f.appendQueryStrings(_, { redirect_uri: r.redirectUri, client_id: r.clientId, scope: i, response_mode: "fragment", state: r.state, nonce: f.generateNonce() })),
                      ...
                      case c.default.MSA:
                        t = (function (e) {
                          ...
                          return f.appendQueryStrings(E, { redirect_uri: e.redirectUri, client_id: e.clientId, response_type: "token", state: e.state, scope: "onedrive." + (t ? "readwrite" : "readonly") });
                        })(e);
                        break;
                      default:
                ...
                : e[o]
                ? b(((i = e), { type: "error", error: new p.default(l.default.badResponse, i[h]), state: i[g] }), t)
                : e[n] && b({ type: "success", accessToken: (r = e)[n], idToken: r[v], state: r[g] }, t);
              var r, i;
            }
            t.handleOauth = T;
            function b(e, t) {
            ...
            t.buildOauthConfig = function (t, e) {
              ...
              var i = t.scopes.map(function (e) {
                ...
                n = { clientId: t.clientId, endpoint: r, scopes: i, origin: window.location.origin, redirectUri: t.redirectUri, switchAccount: e, resource: t.resource },
                o = d.getLoginHint(t);
              if (t.loginHint) {
        ...
        { "../models/DomainHint": 12, "../models/ErrorType": 13, "../models/OauthEndpoint": 15, "../models/OneDriveSdkError": 16, "../utilities/Channel": 24, "../utilities/DomUtilities": 25, "../utilities/ErrorHandler": 26, "../utilities/UrlUtilities": 32, "./LoginCache": 6, "es6-promise": 34 },
      ],
      8: [
        function (e, t, r) {
          !(function (e, t, r, n, o, i, a, s, u, l, d) {
            ...
            var c = (function (i) {
              ...
              t.prototype.buildPickerUXConfig = function (e) {
                return { applicationId: e.clientId, accessLevel: t.ACCESS_LEVEL, filter: e.filter, id: d.generateNonce(), navEnabled: e.navEnabled, origin: window.location.origin, parentDiv: e.parentDiv, redirectUri: e.redirectUri, selectionMode: e.multiSelect ? "multiple" : "single", viewType: e.viewType || "files", accountSwitchEnabled: e.accountSwitchEnabled, commandMode: e.commandMode, qosExtraData: e.qosExtraData };
              };
        ...
        { "../Constants": 1, "../models/ApiEndpoint": 11, "../models/PickerActionType": 17, "../models/PickerOptions": 18, "../utilities/ObjectUtilities": 28, "../utilities/StringUtilities": 30, "../utilities/UrlUtilities": 32, "./ApiRequest": 4, "./Invoker": 5 },
      ],
      9: [
        function (e, t, r) {
          !(function (e, t, r, f, h, i, n, o, a, s, u, v) {
            ...
            var l = (function () {
              function e(e, t) {
                if (e === r.default.graph_odc || e === r.default.msa) this.url = s.appendQueryStrings("https://onedrive.live.com/", { v: "2" });
                      ...
                      if (e.origin === t[0] + "//" + t[2]) {
                        ...
                        if (0 === i.indexOf(m) && e.source === r.getReceiver()) {
                          var n = JSON.parse(i.substring(m.length)),
                            ...
                            s = n.type;
                          if (o === d.id)
                            if ("initialize" === s) r.send("[OneDrive-ToPicker]" + JSON.stringify({ pickerId: o, conversationId: a, type: "activate" }), e.origin);
                            else {
                              u(n);
        ...
        { "../Constants": 1, "../models/ApiEndpoint": 11, "../models/ErrorType": 13, "../models/OneDriveSdkError": 16, "../utilities/Channel": 24, "../utilities/DomUtilities": 25, "../utilities/ErrorHandler": 26, "../utilities/Logging": 27, "../utilities/UrlUtilities": 32, "es6-promise": 34 },
      ],
      10: [
        function (e, t, r) {
          !(function (e, t, n, o, r, a, s, u, l, d) {
            ...
            var i = (function (i) {
              ...
              e.prototype.buildPickerUXConfig = function (e) {
                return { applicationId: e.clientId, accessLevel: "readwrite", id: d.generateNonce(), navEnabled: e.navEnabled, filter: e.filter, origin: window.location.origin, parentDiv: e.parentDiv, redirectUri: e.redirectUri, selectionMode: "single", viewType: "folders", accountSwitchEnabled: e.accountSwitchEnabled, commandMode: e.commandMode, qosExtraData: e.qosExtraData };
              };
              e.prototype.makeApiRequest = function (e) {
                ...
                if (t.uploadType === l.default.form) {
                  i = { name: t.fileName, "@name.conflictBehavior": t.nameConflictBehavior };
        ...
        { "../Constants": 1, "../models/SaverActionType": 19, "../models/SaverOptions": 20, "../models/UploadType": 21, "../utilities/ObjectUtilities": 28, "../utilities/UrlUtilities": 32, "./ApiRequest": 4, "./Invoker": 5 },
      ],
      11: [
        function (e, t, r) {
          !(function (e, t) {
      ...
      14: [
                ...
                n.prototype.parseAdvancedOptions = function (e) {
                  if (e.advanced) {
                    ...
                    if (e.advanced.queryParameters) {
                      ...
                      for (var r in t) "select" !== r.toLowerCase() && "expand" !== r.toLowerCase() && u.throwError(new c.default(l.default.optionsError, p.format("unexpected query key: {0} is found in advanced.queryParameters", r)));
                      var i = t.select,
                        n = t.expand;
        ...
        { "../Constants": 1, "../utilities/CallbackInvoker": 23, "../utilities/ErrorHandler": 26, "../utilities/Logging": 27, "../utilities/StringUtilities": 30, "../utilities/TypeValidators": 31, "../utilities/UrlUtilities": 32, "./DomainHint": 12, "./ErrorType": 13, "./OneDriveSdkError": 16 },
      ],
      15: [
        function (e, t, r) {
          !(function (e, t) {
      ...
      18: [
        ...
        { "../Constants": 1, "../utilities/CallbackInvoker": 23, "../utilities/Logging": 27, "../utilities/TypeValidators": 31, "./InvokerOptions": 14, "./PickerActionType": 17 },
      ],
      19: [
        function (e, t, r) {
          !(function (e, t) {
      ...
      20: [
        ...
        { "../Constants": 1, "../utilities/CallbackInvoker": 23, "../utilities/DomUtilities": 25, "../utilities/ErrorHandler": 26, "../utilities/Logging": 27, "../utilities/StringUtilities": 30, "../utilities/TypeValidators": 31, "../utilities/UrlUtilities": 32, "./ErrorType": 13, "./InvokerOptions": 14, "./OneDriveSdkError": 16, "./SaverActionType": 19, "./UploadType": 21 },
      ],
      21: [
        function (e, t, r) {
          !(function (e, t) {
      ...
      22: [
        ...
        { "../models/ErrorType": 13, "../models/OneDriveSdkError": 16, "./ErrorHandler": 26 },
      ],
      23: [
        function (e, t, r) {
          !(function (e, t, n) {
      ...
      25: [
        ...
        { "../models/ErrorType": 13, "../models/OneDriveSdkError": 16, "./ErrorHandler": 26, "./UrlUtilities": 32 },
      ],
      26: [
        function (e, t, r) {
          !(function (e, t, i) {
      ...
      29: [
        ...
        { "../models/ErrorType": 13, "../models/OneDriveSdkError": 16, "../utilities/UrlUtilities": 32, "./ErrorHandler": 26, "./Logging": 27 },
      ],
      30: [
        function (e, t, r) {
          !(function (e, t) {
      ...
      31: [
        ...
        { "../Constants": 1, "../models/ErrorType": 13, "../models/OneDriveSdkError": 16, "./ErrorHandler": 26, "./Logging": 27, "./ObjectUtilities": 28, "./StringUtilities": 30 },
      ],
      32: [
        function (e, t, r) {
        ...
        { "../Constants": 1, "../models/ErrorType": 13, "../models/OneDriveSdkError": 16, "./ErrorHandler": 26, "./StringUtilities": 30 },
      ],
      33: [
        function (e, t, r) {
                  ...
                  try {
                    ...
                    this._request.upload.onprogress = function (e) {
                      if (e.lengthComputable) {
                        var t = { bytesTransferred: e.loaded, totalBytes: e.total, progressPercentage: 0 === e.total ? 0 : (e.loaded / e.total) * 100 };
        ...
        { "../Constants": 1, "../models/ApiEndpoint": 11, "../models/ErrorType": 13, "../models/OneDriveSdkError": 16, "./ErrorHandler": 26, "./Logging": 27, "./StringUtilities": 30 },
      ],
      34: [
        function (L, e, t) {
          /*!
          ...
          (r = this),
            (i = function () {
              ...
              function P(e, t, r) {
                t.constructor === e.constructor && r === v && t.constructor.resolve === m
                  ? ((o = e),
                    (a = t)._state === E
                      ? U(o, a._result)
                      : a._state === w
